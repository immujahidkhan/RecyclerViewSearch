...
public class MainActivity extends AppCompatActivity implements ContactsAdapter.ContactsAdapterListener {
    ...
    private void ViewsData() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "http://incometax.aliakhtaradnan.com/api/getSro",
                        ...
                        try {
                            ...
                            if (jObject.has("response_code")) {
                                ...
                                if (response_code.equals("200")) {
                                    JSONArray responseArray = jObject.getJSONArray("sro");
